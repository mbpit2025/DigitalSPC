...
const PLCS = [
    ...
    { id: "3", name: 'CHILLER_LINE_1', ip: '10.2.13.76', port: 5000, unitId: 3,
        tagRanges: {
    ...
    { id: "5", name: 'HEATING_LINE_2', ip: '10.2.13.78', port: 5000, unitId: 5,
      tagRanges: {
    ...
    { id: "6", name: 'CHILLER_LINE_2', ip: '10.2.13.95', port: 5000, unitId: 6,
        tagRanges: {
          'default': { min: 26, max: 29 }
      }
     }

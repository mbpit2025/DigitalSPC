...
export default function TemperatureChart({
  ...
  }, [sensor1, sensor2, minValue, maxValue, labels]);
  ...
  const options: ApexCharts.ApexOptions = {
    ...
    stroke: {
      curve: "smooth",
      width: [2, 2, 1.5, 1.5], // thicker for sensors, thinner for thresholds
      dashArray: [0, 0, 5, 5], // dashed lines for min/max
    },
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-4 sm:pt-6 col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
      <div className="w-full">
        <h3 className="text-gray-900 dark:text-gray-100">Chart Title</h3>

// ./src/components/charts/line/ChartBPM.tsx
"use client";
...
const TAG_LABELS: { [key: string]: string } = {
    "data2": "Cold Temp #1", "data3": "Cold Temp #2", "data8": "Cold Temp #3", "data9": "Cold Temp #4", 
    "data4": "Hot Temp #1", "data5": "Hot Temp #2", "data6": "Hot Temp #3", "data7": "Hot Temp #4",
};

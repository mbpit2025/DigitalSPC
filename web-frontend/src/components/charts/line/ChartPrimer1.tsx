...
export const ChartPrimer1 = ({ selectedCell, selectedModel, title }: RealtimeChartProps) => {
  ...
  const standards =
    ...
    const createAnnotations = useCallback((): Record<string, LineAnnotation> => {
        ...
        annotations['upperMax'] = createLineAnnotation(standards.PM1_UP_TEMP_MAX, 'Upper Std', hotColor, 'end', 'MAX');
        annotations['upperMin'] = createLineAnnotation(standards.PM1_UP_TEMP_MIN, 'Upper Std', hotColor, 'start', 'MIN');
        
        const coldColor = 'rgb(0, 0, 255)'; 
        annotations['outsoleMax'] = createLineAnnotation(standards.PM1_OT_TEMP_MAX, 'Outsole Std', coldColor, 'end', 'MAX');
        annotations['outsoleMin'] = createLineAnnotation(standards.PM1_OT_TEMP_MIN, 'Outsole Std', coldColor, 'start', 'MIN');

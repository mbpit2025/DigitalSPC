...
const CELL_MAP: { [key: string]: CellConfig } = {
    'B1-01': {
        plcId: "2", upper: "data2", outsole: "data3",
    },
    'B1-02': {
...
const TAG_LABELS: { [key: string]: string } = {
    "data2": "Upper Temp", "data3": "Outsole Temp", 
};
...
export const ChartPreheat = ({ selectedCell, selectedModel, title }: CardProps) => {
 ...
   
    ...
    annotations['hotMax'] = createLineAnnotation(standards.PR_OT_TEMP_MAX, 'Outsole Std', hotColor, 'end', 'MAX');
    annotations['hotMin'] = createLineAnnotation(standards.PR_OT_TEMP_MIN, 'Outsole Std', hotColor, 'start', 'MIN');
    
    const coldColor = 'rgb(0, 0, 255)'; 
    annotations['coldMax'] = createLineAnnotation(standards.PR_UP_TEMP_MAX, 'Upper Std', coldColor, 'end', 'MAX');
    annotations['coldMin'] = createLineAnnotation(standards.PR_UP_TEMP_MIN, 'Upper Std', coldColor, 'start', 'MIN');

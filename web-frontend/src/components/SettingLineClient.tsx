...
const parameterMap: Record<string, { label: string; order: number }> = {
  ...
  CH_OT_TEMP: { label: 'Chiller CP01 Temp', order: 15 },
  CH_UP_TEMP: { label: 'Chiller CP02 Temp', order: 16 },
  CM_OT_TEMP: { label: 'Cementing Outsole Temperature', order: 11 },
  CM_UP_TEMP: { label: 'Cementing Upper Temperature', order: 12 },
  GM_PRESS: { label: 'Gauge Marking Pressure', order: 5 },
  GM_TIME: { label: 'Gauge Marking Time', order: 6 },
  PM1_OT_TEMP: { label: 'Primer 1/ Cleaning Outsole Temp', order: 7 },
  PM1_UP_TEMP: { label: 'Primer 1/ Cleaning Upper Temp', order: 8 },
  PM2_OT_TEMP: { label: 'Primer 2 Outsole Temp', order: 9 },
  PM2_UP_TEMP: { label: 'Primer 2 Upper Temp', order: 10 },
  PR_OT_TEMP: { label: 'Pre Heating Outsole Temp', order: 3 },
  PR_UP_TEMP: { label: 'Pre Heating Upper Temp', order: 4 },
  UP_PRESSURE: { label: 'Universal Press Pressure', order: 13 },
  UP_TIME: { label: 'Universal Press Time', order: 14 },
};
